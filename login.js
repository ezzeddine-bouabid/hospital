...
app.post('/signup', (req, res) => {
  ...
  const query = `INSERT INTO doctor (name, email, phone, cin, password, code, gender, birth) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`;
  connection.query(query, [name, email, tlfn, CIN, psw, Code, gender, birth], (error, results, fields) => {
    if (error) {
